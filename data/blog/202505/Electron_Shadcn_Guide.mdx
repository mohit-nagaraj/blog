---
title: 'Smooth Sailing: Electron + Vite + Tailwind CSS v4 + ShadCN UI (2025 Setup Guide)'
date: '2025-05-20'
tags: ['Electron', 'Vite', 'Tailwind CSS', 'ShadCN UI', 'React', 'JavaScript', 'Desktop Apps']
draft: false
summary: 'A gentle, step-by-step guide to wiring up an Electron desktop app with Vite, Tailwind CSS v4, and ShadCN UI in 2025 - with path aliases, dev scripts, and common pitfalls explained in plain English.'
...
### 4. Add a **JavaScript-friendly** alias
...
| Prod build ships 5 MB of icons                    | Tree-shake ShadCN icon imports by using `import { ArrowRight } from 'lucide-react'` instead of `import * as Icons` |                                                                                                            |
